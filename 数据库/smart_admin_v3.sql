...
-- Records of t_config
-- ----------------------------
INSERT INTO `t_config` VALUES (1, '万能密码', 'super_password', '1024ok', '执行示例任务2', '2025-09-10 17:54:23', '2021-12-16 23:32:46');
...
CREATE TABLE `t_goods`  (
  ...
  `goods_status` int(11) NULL DEFAULT NULL COMMENT '商品状态:[1:预约中,2:售卖中,3:售罄]',
...
) ENGINE = InnoDB AUTO_INCREMENT = 198 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '公用服务 - 服务心跳' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_heart_beat_record
-- ----------------------------
INSERT INTO `t_heart_beat_record` VALUES (188, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 28840, '2025-09-10 17:54:05', '2025-09-10 17:55:13');
INSERT INTO `t_heart_beat_record` VALUES (189, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 12740, '2025-09-10 17:56:22', '2025-09-10 18:12:29');
INSERT INTO `t_heart_beat_record` VALUES (190, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 6860, '2025-09-10 18:19:52', '2025-09-10 18:21:00');
INSERT INTO `t_heart_beat_record` VALUES (191, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 27012, '2025-09-10 18:25:54', '2025-09-10 18:27:02');
INSERT INTO `t_heart_beat_record` VALUES (192, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 33272, '2025-09-10 18:27:58', '2025-09-10 18:29:06');
INSERT INTO `t_heart_beat_record` VALUES (193, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 23912, '2025-09-10 18:30:40', '2025-09-10 18:31:48');
INSERT INTO `t_heart_beat_record` VALUES (194, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 33400, '2025-09-10 18:34:01', '2025-09-10 18:35:08');
INSERT INTO `t_heart_beat_record` VALUES (195, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 33168, '2025-09-10 18:35:29', '2025-09-10 18:36:36');
INSERT INTO `t_heart_beat_record` VALUES (196, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 25540, '2025-09-10 18:37:22', '2025-09-10 18:38:30');
INSERT INTO `t_heart_beat_record` VALUES (197, 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', '127.0.0.1;198.18.0.1;192.168.1.135', 31824, '2025-09-10 18:39:13', '2025-09-10 18:45:21');
...
CREATE TABLE `t_help_doc_view_record`  (
  ...
  `page_view_count` int(11) NULL DEFAULT 0 COMMENT '查看次数',
...
CREATE TABLE `t_login_fail`  (
  ...
  `login_fail_count` int(11) NULL DEFAULT NULL COMMENT '连续登录失败次数',
  `lock_flag` tinyint(4) NULL DEFAULT 0 COMMENT '锁定状态:1锁定，0未锁定',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1907 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户登录日志' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_login_log
-- ----------------------------
INSERT INTO `t_login_log` VALUES (1905, 1, 1, '管理员', '127.0.0.1', '0|0|0|内网IP|内网IP', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36 Edg/139.0.0.0', '电脑端', 0, '', '2025-09-10 18:39:01', '2025-09-10 18:39:01');
INSERT INTO `t_login_log` VALUES (1906, 1, 1, '管理员', '127.0.0.1', '0|0|0|内网IP|内网IP', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36 Edg/139.0.0.0', NULL, 2, NULL, '2025-09-10 18:39:04', '2025-09-10 18:39:05');
...
) ENGINE = InnoDB AUTO_INCREMENT = 301 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4501 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_operate_log
-- ----------------------------
INSERT INTO `t_operate_log` VALUES (4499, 1, 1, '管理员', 'OA办公-通知公告', '【员工】通知公告-查询全部 @author 卓大', '/oa/notice/employee/query', 'net.lab1024.sa.admin.module.business.oa.notice.controller.NoticeController.queryEmployeeNotice', '[{\"noticeTypeId\":1,\"pageNum\":1,\"pageSize\":6,\"searchCount\":false}]', '{\"code\":0,\"dataType\":1,\"msg\":\"操作成功\",\"ok\":true}', '127.0.0.1', '0|0|0|内网IP|内网IP', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36 Edg/139.0.0.0', 1, NULL, '2025-09-10 18:39:02', '2025-09-10 18:39:02');
INSERT INTO `t_operate_log` VALUES (4500, 1, 1, '管理员', 'OA办公-通知公告', '【员工】通知公告-查询全部 @author 卓大', '/oa/notice/employee/query', 'net.lab1024.sa.admin.module.business.oa.notice.controller.NoticeController.queryEmployeeNotice', '[{\"noticeTypeId\":2,\"pageNum\":1,\"pageSize\":6,\"searchCount\":false}]', '{\"code\":0,\"dataType\":1,\"msg\":\"操作成功\",\"ok\":true}', '127.0.0.1', '0|0|0|内网IP|内网IP', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36 Edg/139.0.0.0', 1, NULL, '2025-09-10 18:39:02', '2025-09-10 18:39:02');
...
CREATE TABLE `t_serial_number`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `last_number` bigint(20) NULL DEFAULT NULL COMMENT '上次产生的单号, 默认为空',
...
CREATE TABLE `t_smart_job`  (
  ...
  `last_execute_log_id` int(11) NULL DEFAULT NULL COMMENT '最后一次执行记录id',
  `sort` int(11) NOT NULL DEFAULT 0 COMMENT '排序',
...
INSERT INTO `t_smart_job` VALUES (2, '示例任务2', 'net.lab1024.sa.base.module.support.job.sample.SmartJobSample2', 'fixed_delay', '120', 1, '执行示例任务2', '2025-09-10 18:45:31', 7949, 2, '执行示例任务2', 0, '管理员', '2024-06-18 20:45:35', '2025-09-10 18:45:31');
...
CREATE TABLE `t_smart_job_log`  (
  ...
  `execute_time_millis` int(11) NULL DEFAULT NULL COMMENT '执行时长',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7950 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时任务-执行记录 @listen' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_smart_job_log
-- ----------------------------
INSERT INTO `t_smart_job_log` VALUES (7933, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 17:54:23', 6, '2025-09-10 17:54:23', '执行成功,本次处理数据1条', '198.18.0.1', '28840', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 17:54:23');
INSERT INTO `t_smart_job_log` VALUES (7934, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 17:56:39', 7, '2025-09-10 17:56:39', '执行成功,本次处理数据1条', '198.18.0.1', '12740', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 17:56:38');
INSERT INTO `t_smart_job_log` VALUES (7935, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:00:39', 5, '2025-09-10 18:00:39', '执行成功,本次处理数据1条', '198.18.0.1', '12740', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:00:38');
INSERT INTO `t_smart_job_log` VALUES (7936, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:04:39', 5, '2025-09-10 18:04:39', '执行成功,本次处理数据1条', '198.18.0.1', '12740', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:04:38');
INSERT INTO `t_smart_job_log` VALUES (7937, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:08:39', 4, '2025-09-10 18:08:39', '执行成功,本次处理数据1条', '198.18.0.1', '12740', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:08:38');
INSERT INTO `t_smart_job_log` VALUES (7938, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:10:39', 5, '2025-09-10 18:10:39', '执行成功,本次处理数据1条', '198.18.0.1', '12740', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:10:39');
INSERT INTO `t_smart_job_log` VALUES (7939, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:12:39', 7, '2025-09-10 18:12:39', '执行成功,本次处理数据1条', '198.18.0.1', '12740', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:12:39');
INSERT INTO `t_smart_job_log` VALUES (7940, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:20:09', 7, '2025-09-10 18:20:09', '执行成功,本次处理数据1条', '198.18.0.1', '6860', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:20:09');
INSERT INTO `t_smart_job_log` VALUES (7941, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:22:10', 5, '2025-09-10 18:22:10', '执行成功,本次处理数据1条', '198.18.0.1', '6860', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:22:09');
INSERT INTO `t_smart_job_log` VALUES (7942, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:26:11', 6, '2025-09-10 18:26:11', '执行成功,本次处理数据1条', '198.18.0.1', '27012', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:26:11');
INSERT INTO `t_smart_job_log` VALUES (7943, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:28:16', 6, '2025-09-10 18:28:16', '执行成功,本次处理数据1条', '198.18.0.1', '33272', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:28:16');
INSERT INTO `t_smart_job_log` VALUES (7944, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:30:16', 8, '2025-09-10 18:30:16', '执行成功,本次处理数据1条', '198.18.0.1', '33272', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:30:16');
INSERT INTO `t_smart_job_log` VALUES (7945, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:32:57', 8, '2025-09-10 18:32:57', '执行成功,本次处理数据1条', '198.18.0.1', '23912', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:32:57');
INSERT INTO `t_smart_job_log` VALUES (7946, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:35:46', 6, '2025-09-10 18:35:46', '执行成功,本次处理数据1条', '198.18.0.1', '33168', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:35:46');
INSERT INTO `t_smart_job_log` VALUES (7947, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:39:31', 10, '2025-09-10 18:39:31', '执行成功,本次处理数据1条', '198.18.0.1', '31824', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:39:30');
INSERT INTO `t_smart_job_log` VALUES (7948, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:43:31', 7, '2025-09-10 18:43:31', '执行成功,本次处理数据1条', '198.18.0.1', '31824', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:43:31');
INSERT INTO `t_smart_job_log` VALUES (7949, 2, '示例任务2', '执行示例任务2', 1, '2025-09-10 18:45:31', 7, '2025-09-10 18:45:31', '执行成功,本次处理数据1条', '198.18.0.1', '31824', 'D:\\Yao\\Desktop\\OA\\smart-admin\\smart-admin-api-java17-springboot3', 'system', '2025-09-10 18:45:31');
